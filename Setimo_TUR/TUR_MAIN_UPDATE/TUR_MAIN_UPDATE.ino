...
if ((leitura0 < LIMIAR_SENSORES && leitura1 < LIMIAR_SENSORES && leitura2 < LIMIAR_SENSORES && leitura3 < LIMIAR_SENSORES && leitura4 < LIMIAR_SENSORES) && millis() >= 15000)
  {
   /* linha_final = millis();
    while(1){
